...
위 코드를 실행하면 "[]+-.<>"인 brainfuck 코드를 제외하고 다 지워줍니다.

![](https://i.imgur.com/dUUTl7m.png)

나온 코드를 실행해보면 플래그가 나옵니다!
